...
const LineChart = ({
  ...
  if (!currentData[currentCountry] || (currentData[currentCountry].confirmed === "no data")) {
    const noData = {
...
const mapStateToProps = (state) => {
  return {
    loading: state.country.loadingMonthly[state.country.currentCountry] || state.country.loadingSixMonth[state.country.currentCountry],
